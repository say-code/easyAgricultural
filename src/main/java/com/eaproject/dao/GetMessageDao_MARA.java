...
public class GetMessageDao_MARA {
    ...
    public GetMessageDao_MARA() {
        ...
        try {
            ...
            System.out.println("GetMessageDao_MARA发来贺电：数据库连接成功！");
...
//                    System.out.println(maraLink.get(i));
    ...
    public List<String> getMaraMessage() {
        return maraMessage;
    }

    public List<String> getMaraLink() {
        return maraLink;
    }

    public List<Date> getMaraTime() {
        return maraTime;
    }
